    ...
    for i in mail_ids:
        ...
        for response_part in data:
            ...
            if isinstance(response_part, tuple):
                ...
                data_file = os.path.join(script_directory, "email1.txt")
                ...
                for row in rows:
                    ...
                    if link != None:
                        Event.objects.create(title=link.get_text(), link=link['href'], linkedin=linkedin['href'], twitter=twitter['href'], facebook=facebook['href'], post_date=mail_date)
                        print(i)
