...
class Event(models.Model):
    ...
    visitors_number = models.IntegerField(validators=[MaxValueValidator(99999),MinValueValidator(1)], null = True, blank = True)
    exhibitors_number = models.IntegerField(validators=[MaxValueValidator(99999),MinValueValidator(1)], null = True, blank = True)
