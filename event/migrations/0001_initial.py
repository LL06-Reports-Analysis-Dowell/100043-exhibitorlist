# Generated by Django 3.1.2 on 2021-09-28 13:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exhibitor_creator_list', models.EmailField(blank=True, max_length=254, null=True)),
                ('city', models.CharField(blank=True, max_length=200, null=True)),
                ('country', models.CharField(blank=True, max_length=200, null=True)),
                ('BDEventID', models.IntegerField(blank=True, null=True)),
                ('status', models.CharField(blank=True, choices=[('Complete', 'Complete'), ('InProgress', 'InProgress'), ('Error', 'Error')], max_length=12, null=True)),
            ],
        ),
    ]
